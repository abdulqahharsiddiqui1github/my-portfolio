...
const Footer = () => {
  return (
    <footer className="md:flex px-20 lg:justify-between h-[15vh] items-center bg-green-300-400 text-neutral-content">
      ...
      <aside className="">
       ...
       <p> © Copyright Siddiqui Abdul Qahhar All right reserved</p>
       </div>
